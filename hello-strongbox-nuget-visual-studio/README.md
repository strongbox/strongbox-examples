...
![NuGet Package Resources](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Package-Resources.png "Add new NuGet Package Resources")
...
![Search log4net](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Package-log4net.png "Search result with Strongbox NuGet Layout provider")
...
![Manage NuGet Packages](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Manage-Packages.png "Manage NuGet Packages")

You should switch to StrongBox repository in source tab and search for the package that you built in previous steps. 

![Switch to Strongbox Repo](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Switch-Repository.png "Switch to Strongbox Repo")



Search for the NuGet package, select and install the version that is available.

![Install NuGet Package](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Search-Repository.png "Install NuGet Package")
...
```
![Install with Package Manager Console](https://github.com/strongbox/strongbox/docs/assets/images/NuGet-Package-Manager-Console.png "Install with Package Manager Console")
